...
describe ProductsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'when a new product created' do
      ...
      it 'new product with valid details will be stored' do
  ...
  describe 'PUT/PATCH #update' do
    ...
    it "updates product's name" do
      @user_admin = FactoryBot.create(:admin)
      sign_in @user_admin
      @update = { id: @product_id, name: @product.name, description: @product.description, image_url: @product.image_url,  price: @product.price }
